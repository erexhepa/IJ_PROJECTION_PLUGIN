package SME_ENS.SME_PROJECTION_SRC;

/******************************************************************************
 *  Compilation:  javac SME_Complex.java
 *  Execution:    java SME_Complex
 *
 *  Data type for complex numbers.
 *
 *  The data type is "immutable" so once you create and initialize
 *  a SME_Complex object, you cannot change it. The "final" keyword
...
public class SME_Complex {
    ...
    // return a string representation of the invoking SME_Complex object
    ...
    // return a new SME_Complex object whose value is (this + b)
    ...
    // return a new SME_Complex object whose value is the conjugate of this
    public SME_Complex conjugate() {  return new SME_Complex(re, -im); }

    // return a new SME_Complex object whose value is the reciprocal of this
    ...
    // return a new SME_Complex object whose value is the complex exponential of this
    public SME_Complex exp() {
        return new SME_Complex(Math.exp(re) * Math.cos(im), Math.exp(re) * Math.sin(im));
    }

    // return a new SME_Complex object whose value is the complex sine of this
    public SME_Complex sin() {
        return new SME_Complex(Math.sin(re) * Math.cosh(im), Math.cos(re) * Math.sinh(im));
    }

    // return a new SME_Complex object whose value is the complex cosine of this
    public SME_Complex cos() {
        return new SME_Complex(Math.cos(re) * Math.cosh(im), -Math.sin(re) * Math.sinh(im));
    }

    // return a new SME_Complex object whose value is the complex tangent of this
